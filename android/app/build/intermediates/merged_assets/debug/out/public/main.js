...
const redirectUnauthorizedToLogin = () => (0,_angular_fire_compat_auth_guard__WEBPACK_IMPORTED_MODULE_0__.redirectUnauthorizedTo)(['usuario/login']);
// Redireciona usuário já logado para a página home
const redirectLoggedInToItems = () => (0,_angular_fire_compat_auth_guard__WEBPACK_IMPORTED_MODULE_0__.redirectLoggedInTo)(['inicio']);
const routes = [
    {
        path: '',
        redirectTo: 'inicio',
    ...
    {
        path: 'usuarios',
        loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("default-node_modules_firebase_firestore_dist_index_esm_js"), __webpack_require__.e("src_app_page_user_user_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./page/user/user.module */ 5358)).then(m => m.UserPageModule)
    },
    {
        path: 'documentos',
    ...
    {
        path: 'contatos',
        loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("default-node_modules_firebase_firestore_dist_index_esm_js"), __webpack_require__.e("src_app_page_contacts_contacts_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./page/contacts/contacts.module */ 3903)).then(m => m.ContactsPageModule)
    },
    {
        path: 'sobre',
    ...
    {
        path: 'faq',
        loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("default-node_modules_firebase_firestore_dist_index_esm_js"), __webpack_require__.e("src_app_page_faq_faq_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./page/faq/faq.module */ 5546)).then(m => m.FaqPageModule)
    },
    /**
     ...
     */
    {
        ...
        path: 'db/faq',
        loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("default-node_modules_firebase_firestore_dist_index_esm_js"), __webpack_require__.e("src_app_db_faq_faq_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./db/faq/faq.module */ 4326)).then(m => m.FaqPageModule)
    },
    // Cria a coleção 'manual' no Firestore.
    {
        path: 'db/manual',
        loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("default-node_modules_firebase_firestore_dist_index_esm_js"), __webpack_require__.e("src_app_db_manual_manual_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./db/manual/manual.module */ 3810)).then(m => m.ManualPageModule)
    },
    {
        path: 'view/:id',
        loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("default-node_modules_firebase_firestore_dist_index_esm_js"), __webpack_require__.e("src_app_page_view_view_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./page/view/view.module */ 8021)).then(m => m.ViewPageModule)
    },
    {
        path: 'usuario/login',
        loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_user_login_login_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./user/login/login.module */ 9470)).then(m => m.LoginPageModule),
    ...
    {
        path: 'usuario/logout',
        loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_user_logout_logout_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./user/logout/logout.module */ 7636)).then(m => m.LogoutPageModule),
